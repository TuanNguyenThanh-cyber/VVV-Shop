        ...
        <new className="newsdetail">
            <div className="container">
                <div className="breadcrumb">                  
                    ...
                    <span> / </span>
                    <Link to="/news" className="infobreadcrumb">Tin tức</Link>
                    <span> / </span>
                    <Link to="#" className="infobreadcrumb active">{datanewsdetail.name}</Link>
                </div>

                <div className="newsimg">
                    <img className="image" src="/images/top-8-laptop-gaming-2021.png"></img>
                </div>
                ...
                <div className="row newsbody">
                    <div className="col-8 newsinfo">
                        ...
                        <div className="row authinfo">
                            <div className="authimage"><img className="authimg" src={datanewsdetail.author.avatar}></img></div>
                            ...
                            <span className="titlepopular">BÀI VIẾT PHỔ BIẾN</span>
                                ...
                                {datablog && datablog.map((item) => (
                                    <>
                                        <div className="row">
                                            <div className="col-4">
                                                <img className="newsimages" src="#" alt="news_image"></img>
                                            </div>
                                            <div className="col-8 newsinfo">
